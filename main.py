...
**Как формировать пост (ОБЯЗАТЕЛЬНО!)
Пост на сервере вальдес формируеться по такому принципу:
"Так мы обозночаем мысли персонажа"
*Так мы обозначаем действия персонажа*
- Так мы обозночаем что говорит персонаж

**Как форрмировать пост (Пример)**
*Встает с постели и идет на прогулку*
"Как же прекрасен этот день"
- Привет птичка
